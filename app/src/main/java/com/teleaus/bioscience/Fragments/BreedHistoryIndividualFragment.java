...
import com.teleaus.bioscience.Adapter.RecentDogBreedResultAdapter;
...
public class BreedHistoryIndividualFragment extends Fragment {
    ...
    ImageView imageUrlShow,coverImage;
    CircularImageView progressBarImage;
    String picture, image_url, classification;
    int id;
    PhotoView recyclerViewImage;

    private int currentProgress = 0;
    private ProgressBar progressBar;
    ArrayList<LocalHistoryResponseData> listResult;
    ...
    String breedPopUpName, PopUpPercentage, PopUpOrigin;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_breed_history_individual, container, false);

        StrictMode.VmPolicy.Builder builder = new StrictMode.VmPolicy.Builder();
        StrictMode.setVmPolicy(builder.build());

        Bundle extras = getArguments();
        listResult  = extras.getParcelableArrayList("list");
        id = extras.getInt("id");
    ...
    private void initialise(View view) {
        ...
        bundle.putString(FirebaseAnalytics.Param.SCREEN_NAME, "BreedIndividualHistoryScreen");
        bundle.putString(FirebaseAnalytics.Param.SCREEN_CLASS, "BreedIndividualHistoryScreen");
        ...
        /*mainShareLayout = view.findViewById(R.id.mainShareLayout);*/
        ...
        chartImage = view.findViewById(R.id.chartImage);
        outputImage = view.findViewById(R.id.outputImage);
        outputImageName = view.findViewById(R.id.outputImageName);
        originName = view.findViewById(R.id.originName);
        lifeSpanShow = view.findViewById(R.id.lifeSpanShow);*/
    ...
    private void showAdapter(ArrayList<LocalHistoryResponseData> listResult) {
        if (!listResult.isEmpty()){
            adapterSetOnClickListener(listResult);
            RecentDogBreedResultAdapter recentDogBreedResultAdapter = new RecentDogBreedResultAdapter(listResult,getContext(),adapterListener);
            recyclerView.setAdapter(recentDogBreedResultAdapter);
        }
    }

    private void adapterSetOnClickListener(final ArrayList<LocalHistoryResponseData> listResult) {
        adapterListener = new RecentDogBreedResultAdapter.RecyclerViewClickListener() {
            @Override
    ...
    private void showChart(ArrayList<LocalHistoryResponseData> listResult, int range) {
