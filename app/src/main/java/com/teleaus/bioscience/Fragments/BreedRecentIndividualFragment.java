...
public class BreedRecentIndividualFragment extends Fragment {
    ...
    Toolbar toolbarId;
    private HistoryDogBreedResultAdapter.RecyclerViewClickListener adapterListener;
    ...
    ArrayList<BreedHistoryResponseData> listResult;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_breed_recent_individual, container, false);
    ...
    private void showAdapter(ArrayList<BreedHistoryResponseData> listResult) {
        if (!listResult.isEmpty()){
            adapterSetOnClickListener(listResult);
            HistoryDogBreedResultAdapter historyDogBreedResultAdapter = new HistoryDogBreedResultAdapter(listResult,getContext(),adapterListener);
            recyclerView.setAdapter(historyDogBreedResultAdapter);
        }
    }

    private void adapterSetOnClickListener(final ArrayList<BreedHistoryResponseData> listResult) {
        adapterListener = new HistoryDogBreedResultAdapter.RecyclerViewClickListener() {
            @Override
    ...
    private void showChart(ArrayList<BreedHistoryResponseData> listResult, int range) {
    ...
    private void createShareDialog(View view, Bitmap resultBitmap) {
       ...
       /* Glide.with(this)
        ...
        outputImageName.setText(breedPopUpName);
        /*originName.setText(PopUpLifeSpan.toString());*/
