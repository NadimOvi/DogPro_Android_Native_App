...
public class HistoryDogBreedResultAdapter extends RecyclerView.Adapter<HistoryDogBreedResultAdapter.ViewHolder>  {
    private ArrayList<BreedHistoryResponseData> list;
    ...
    public HistoryDogBreedResultAdapter(ArrayList<BreedHistoryResponseData> list, Context context, RecyclerViewClickListener adapterListener) {
        this.list = list;
    ...
    @NotNull
    @Override
    public HistoryDogBreedResultAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.recent_dog_view_holder,viewGroup,false);
        return new HistoryDogBreedResultAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull HistoryDogBreedResultAdapter.ViewHolder holder, int position) {
        BreedHistoryResponseData dataClass = list.get(position);
