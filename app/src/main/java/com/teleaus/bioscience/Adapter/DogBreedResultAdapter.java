...
public class DogBreedResultAdapter extends RecyclerView.Adapter<DogBreedResultAdapter.ViewHolder> {
    private ArrayList<DataClass> list;
    private Context context;
    private RecyclerViewClickListener adapterListener;
    ...
    public DogBreedResultAdapter(ArrayList<DataClass> list, Context context, RecyclerViewClickListener adapterListener) {
        this.list = list;
    ...
    @NonNull
    @Override
    public DogBreedResultAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.profile_view_holder,viewGroup,false);
        return new DogBreedResultAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DogBreedResultAdapter.ViewHolder holder, int position) {
