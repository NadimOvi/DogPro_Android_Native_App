...
public class BreedHistoryResponseData implements Parcelable {
    ...
    public BreedHistoryResponseData() {
    }

    public BreedHistoryResponseData(String breed, String breed_id, ArrayList<String> life_span, String thumbnail, String percentage, ArrayList<String> temperament, ArrayList<String> utilization, ArrayList<String> ideal_height, ArrayList<String> ideal_weight, String brief_history, boolean additional_info, ArrayList<String> alternative_names, String country_of_origin, String fci_classification, String country_of_patronage) {
        this.breed = breed;
    ...
    protected BreedHistoryResponseData(Parcel in) {
        breed = in.readString();
    ...
    public static final Creator<BreedHistoryResponseData> CREATOR = new Creator<BreedHistoryResponseData>() {
        @Override
        public BreedHistoryResponseData createFromParcel(Parcel in) {
            return new BreedHistoryResponseData(in);
        }

        @Override
        public BreedHistoryResponseData[] newArray(int size) {
            return new BreedHistoryResponseData[size];
        }
    };
