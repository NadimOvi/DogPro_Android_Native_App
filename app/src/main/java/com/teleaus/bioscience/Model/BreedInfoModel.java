...
public class BreedInfoModel {
    ...
    private ArrayList<Associated> associated_diseases;
    private String fci_classification;

    public BreedInfoModel() {
    }

    public BreedInfoModel(String breed_id, String breed, String thumbnail, String country_of_origin, String brief_history, ArrayList<String> life_span, ArrayList<String> ideal_weight, ArrayList<String> ideal_height, ArrayList<String> temperament, String country_of_patronage, ArrayList<String> utilization, ArrayList<String> alternative_names, ArrayList<Associated> associated_diseases, String fci_classification) {
    ...
    public ArrayList<Associated> getAssociated_diseases() {
        return associated_diseases;
    }

    public void setAssociated_diseases(ArrayList<Associated> associated_diseases) {
        this.associated_diseases = associated_diseases;
    }
